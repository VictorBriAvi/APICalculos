        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerHistories_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceTypes_ServiceCategories_ServiceCategorieId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleDetails_Employees_EmployeeId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleDetails_ServiceTypes_ServiceTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaIngresoServicio = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Servicios", x => x.ServicioId);
                    table.ForeignKey(
                        name: "FK_Servicios_Clients_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Servicios_Employees_EmpleadoId",
                        column: x => x.EmpleadoId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Servicios_PaymentTypes_TipoDePagoId",
                        column: x => x.TipoDePagoId,
                        principalTable: "PaymentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Servicios_ServiceTypes_TipoDeServicioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerHistories_ClientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleDetails_EmployeeId",
                table: "SaleDetails",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleDetails_ServiceTypeId",
                table: "SaleDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTypes_ServiceCategorieId",
                table: "ServiceTypes",
