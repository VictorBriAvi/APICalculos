...
namespace APICalculos.Migrations
{
    ...
    [Migration("20260309023428_update-sale-discount-sale")]
    partial class updatesalediscountsale
    {
            ...
            modelBuilder.Entity("APICalculos.Domain.Entidades.PaymentTypes", b =>
                {
                    ...
                    b.Property<bool>("ApplySurcharge")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("APICalculos.Domain.Entities.SalePayment", b =>
                {
                    ...
                    b.Property<decimal>("AppDiscountPercent")
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("APICalculos.Domain.Entidades.Sale", b =>
                {
                    ...
                    b.HasOne("APICalculos.Domain.Entidades.Client", null)
                        .WithMany("Sale")
