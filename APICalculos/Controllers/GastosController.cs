    ...
    public class GastosController : ControllerBase
    {
        ...
        public async Task<ActionResult<Gastos>> GetGastosForId (int id)
        {
            ...
            var gastosDTO = new GastosDTO
            {
                ...
                NombreTipoDeGastos = gastoId.TiposDeGastos.NombreTipoDeGastos,
        ...
        {
            var tipoDeGastoExiste = await _dbContext.TiposDeGastos.FindAsync(gastosCreacionDTO.TipoDeGastosId);
